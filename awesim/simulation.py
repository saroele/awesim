...
class Simulation:
    ...
    def __init__(self, filename, verbose = False):
        ...
        if filename.endswith('.txt'):
            ...
            dataInfo, names, data_1, data_2 = None, None, None, None
            ...
            for i,l in enumerate(lines):
                if l.find('dataInfo') > -1 and not l.startswith('#'):
                    ...
                    data_1_active = True                    
                    start = i+1
                    # This does not work cause the file generated by dymola 
                    # ads enters to the line.  Possible solution: real all the lines till next
white line, then make a numpy array and then reshape according to the shape specified.  Should work...                    
                    stop = start + int(l.split('(')[-1].split(',')[0])
                ...
                elif data_1_active and start <= i < stop:
                    data_1 = parse_data_1_2(data_1, l)
                elif data_2_active and start <= i < stop:
                    data_2 = parse_data_1_2(data_2, l)
